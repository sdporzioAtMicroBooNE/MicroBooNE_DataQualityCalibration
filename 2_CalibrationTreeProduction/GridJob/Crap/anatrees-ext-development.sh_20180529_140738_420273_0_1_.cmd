universe          = vanilla
executable        = /fife/local/scratch/uploads/uboone/sporzio/2018-05-29_140715.587231_9786/anatrees-ext-development.sh_20180529_140738_420273_0_1_wrap.sh
arguments         =  --nfile  1  --group  uboone  -g  -c  wrapper.fcl  --ups  uboonecode  -r  development  -b  debug  --localtar  /pnfs/uboone/resilient/users/sporzio/GridFiles/uboonecode_v06_26_01_17.tar  --workdir  /pnfs/uboone/scratch/users/sporzio/Work/DqmCalibrationNtuples/ext/v1/anatrees  --outdir  /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Samples/anatrees  --logdir  /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees  --sam_defname  sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles  --sam_project  sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707  -n  1000000  --end-script  ./merge_dqm_hists.sh  --init  /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh  --validate  --declare  --maintain_parentage  --process  70 
output                = /fife/local/scratch/uploads/uboone/sporzio/2018-05-29_140715.587231_9786/anatrees-ext-development.sh_20180529_140738_420273_0_1_cluster.$(Cluster).$(Process).out
error                 = /fife/local/scratch/uploads/uboone/sporzio/2018-05-29_140715.587231_9786/anatrees-ext-development.sh_20180529_140738_420273_0_1_cluster.$(Cluster).$(Process).err
log                   = /fife/local/scratch/uploads/uboone/sporzio/2018-05-29_140715.587231_9786/anatrees-ext-development.sh_20180529_140738_420273_0_1_.log
environment   = CLUSTER=$(Cluster);PROCESS=$(Process);CONDOR_TMP=/fife/local/scratch/uploads/uboone/sporzio/2018-05-29_140715.587231_9786;CONDOR_EXEC=/tmp;DAGMANJOBID=$(DAGManJobId);JOBSUBJOBSECTION=72;JOBSUBPARENTJOBID=$(DAGManJobId)@jobsub01.fnal.gov;GRID_USER=sporzio;IFDH_BASE_URI=http://samweb.fnal.gov:8480/sam/uboone/api;JOBSUBJOBID=$(CLUSTER).$(PROCESS)@jobsub01.fnal.gov;EXPERIMENT=uboone
rank                  = Mips / 2 + Memory
