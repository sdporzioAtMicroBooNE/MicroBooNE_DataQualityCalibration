...
#
umask 002
# /fife/local/scratch/uploads/uboone/sporzio/2018-05-29_140715.587231_9786/stop-anatrees-ext-development.sh_20180529_140748_423450_0_1_wrap.sh
# Automatically generated by: 
#          jobsub -e JOBSUBJOBSECTION --lines +JobsubJobSection="102" -n -n --group=uboone --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 --expected-lifetime=short --append_condor_requirements=(TARGET.HAS_CVMFS_uboone_opensciencegrid_org==true) -l +JobsubParentJobId="$(DAGManJobId)@jobsub01.fnal.gov" -l +JobsubJobId="$(CLUSTER).$(PROCESS)@jobsub01.fnal.gov" -l +Owner="sporzio" -e JOBSUBPARENTJOBID -l +JobsubServerVersion="1.2.6.2.1" -l +JobsubClientVersion="1.2.5" -l +JobsubClientDN="/DC=org/DC=cilogon/C=US/O=Fermi National Accelerator Laboratory/OU=People/CN=Salvatore davide Porzio/CN=UID:sporzio" -l +JobsubClientIpAddress="131.225.240.146" -l +JobsubClientKerberosPrincipal="sporzio@FNAL.GOV" ./stop-anatrees-ext-development.sh --sam_station uboone --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh 
...
export JOBSUB_EXE_SCRIPT=`find . -name stop-anatrees-ext-development.sh -print`
chmod +x $JOBSUB_EXE_SCRIPT
${JSB_TMP}/ifdh.sh log "sporzio:BEGIN EXECUTION $JOBSUB_EXE_SCRIPT  --sam_station uboone --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh  
 "
...
echo `date` BEGIN EXECUTION $JOBSUB_EXE_SCRIPT  --sam_station uboone --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh  
>&2 echo `date` BEGIN EXECUTION $JOBSUB_EXE_SCRIPT  --sam_station uboone --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh  
$JOBSUB_EXE_SCRIPT --sam_station uboone --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh   
JOB_RET_STATUS=$?
...
${JSB_TMP}/ifdh.sh log "sporzio:stop-anatrees-ext-development.sh COMPLETED with return code $JOB_RET_STATUS" 
exit $JOB_RET_STATUS
