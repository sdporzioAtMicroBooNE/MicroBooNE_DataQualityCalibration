...
export JOBSUB_EXE_SCRIPT=`find . -name start-anatrees-ext-development.sh -print`
chmod +x $JOBSUB_EXE_SCRIPT
${JSB_TMP}/ifdh.sh log "sporzio:BEGIN EXECUTION $JOBSUB_EXE_SCRIPT  --sam_station uboone --sam_group uboone --sam_defname sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh --max_files 100 --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees  
 "
...
echo `date` BEGIN EXECUTION $JOBSUB_EXE_SCRIPT  --sam_station uboone --sam_group uboone --sam_defname sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh --max_files 100 --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees  
>&2 echo `date` BEGIN EXECUTION $JOBSUB_EXE_SCRIPT  --sam_station uboone --sam_group uboone --sam_defname sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh --max_files 100 --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees  
$JOBSUB_EXE_SCRIPT --sam_station uboone --sam_group uboone --sam_defname sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles --sam_project sporzio_prod_extbnb_swizzle_inclusive_v5_17-05-18_1kfiles_20180529140707 -g --init /cvmfs/uboone.opensciencegrid.org/products/setup_uboone.sh --max_files 100 --logdir /pnfs/uboone/scratch/users/sporzio/DqmCalibrationNtuples/ext/v1/Logs/anatrees   
JOB_RET_STATUS=$?
...
${JSB_TMP}/ifdh.sh log "sporzio:start-anatrees-ext-development.sh COMPLETED with return code $JOB_RET_STATUS" 
exit $JOB_RET_STATUS
