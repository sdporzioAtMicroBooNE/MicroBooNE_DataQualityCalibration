...
// Thu Feb  8 13:47:41 2018 by ROOT version 5.34/32
// from TTree Event/Event Tree from Reco
// found on file: /uboone/data/users/vmeddage/final_run_1_calibration.root
//////////////////////////////////////////////////////////

#ifndef Global_median_with_XYZ_corrections_h
#define Global_median_with_XYZ_corrections_h
...
class Global_median_with_XYZ_corrections {
public :
   ...
   Global_median_with_XYZ_corrections(TTree *tree=0);
   virtual ~Global_median_with_XYZ_corrections();
...
#ifdef Global_median_with_XYZ_corrections_cxx
Global_median_with_XYZ_corrections::Global_median_with_XYZ_corrections(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/vmeddage/final_run_1_calibration.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/vmeddage/final_run_1_calibration.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/vmeddage/final_run_1_calibration.root:/XYZcorrection");
...
Global_median_with_XYZ_corrections::~Global_median_with_XYZ_corrections()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Global_median_with_XYZ_corrections::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Global_median_with_XYZ_corrections::LoadTree(Long64_t entry)
{
...
void Global_median_with_XYZ_corrections::Init(TTree *tree)
{
...
Bool_t Global_median_with_XYZ_corrections::Notify()
{
...
void Global_median_with_XYZ_corrections::Show(Long64_t entry)
{
...
Int_t Global_median_with_XYZ_corrections::Cut(Long64_t entry)
{
...
#endif // #ifdef Global_median_with_XYZ_corrections_cxx
