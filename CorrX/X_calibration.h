...
#ifdef X_calibration_cxx
X_calibration::X_calibration(TTree *tree) : fChain(0) 
{
...
Int_t X_calibration::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t X_calibration::LoadTree(Long64_t entry)
{
...
void X_calibration::Init(TTree *tree)
{
...
void X_calibration::Show(Long64_t entry)
{
...
Int_t X_calibration::Cut(Long64_t entry)
{
